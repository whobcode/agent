/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9ba77de90776b188df58e14a489b8272)
// Runtime types generated with workerd@1.20250816.0 2025-07-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DEEPSEEK_API_KEY: "sk-6db33fafb1c844a4abcf5f054e93fb36";
		AI_GATEWAY_NAME: "moongate";
		DEFAULT_MODEL_ID: "deepseek-v3.1";
		DEFAULT_SYSTEM_PROMPT: "You are a helpful AI agent.";
		OPENAI_API_KEY: "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";
		AI_GATEWAY_ENDPOINT: "https://gateway.ai.cloudflare.com/v1/moongate";
		HF_API_KEY: "";
		SERVICE_API_KEY: "";
		mcp: DurableObjectNamespace /* PlaywrightMCP from playwmcp */;
		levister: R2Bucket;
		whobcode: R2Bucket;
		bolt: Fetcher /* bolt */;
		mcpservice: Service /* entrypoint PlaywrightMCP from playwmcp */;
		render: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEEPSEEK_API_KEY" | "AI_GATEWAY_NAME" | "DEFAULT_MODEL_ID" | "DEFAULT_SYSTEM_PROMPT" | "OPENAI_API_KEY" | "AI_GATEWAY_ENDPOINT" | "HF_API_KEY" | "SERVICE_API_KEY">> {}
}
